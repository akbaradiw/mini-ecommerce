...
const Profil = () => {
  return (
    // <div className="pt-20 bg-gradient-to-r from-rose-200 via-orange-200 to-pink-300 ">
    <div className="lg:pt-20 lg:pb-6 pb-3 bg-gradient-to-r from-cyan-200 via-cyan-100 to-cyan-50 ">
      <div className="flex justify-center pb-2 lg:pt-0 pt-5 ">
        <img src={logo} alt="logo" className="lg:w-96 w-60" />
      </div>
      <div className="lg:flex grid lg:px-96 px-10">
        <img src={hatamei} alt="photo" className="lg:w-80 lg:p-0 px-5 pb-4" />
        <div className="lg:pt-4 lg:ps-20">
