...
const ProductPage = () => {
  ...
  return (
    <div>
      ...
      {/* Products Grid */}
      <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-4 gap-6 px-6 md:px-10 py-10 bg-white">
        {products
          .filter((item) =>
          ...
          .map((product) => (
            ...
            >
              <img
                className="w-full  p-6 h-80  sm:h-48 md:h-80 lg:h-60 object-cover  rounded-t-lg"
                src={product.image}
                alt={product.name}
              />
